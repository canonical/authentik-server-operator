# authentik-api-resilience Specification

## Purpose
Defines how the Authentik Server charm's REST API client classifies failures and bounds retries, and how OAuth reconciliation stays resumable and startup-tolerant, so non-transactional Authentik mutations and first-boot readiness gaps never crash hooks or leave duplicate or orphaned resources.
## Requirements
