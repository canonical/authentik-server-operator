...
Python Operator for the Authentik Server

## Security

Please see [SECURITY.md](https://github.com/canonical/authentik-server-operator/blob/main/SECURITY.md)
...
and [CONTRIBUTING.md](https://github.com/canonical/authentik-server-operator/blob/main/CONTRIBUTING.md)
for developer guidance.

## License

The Charmed Authentik Server is free software, distributed under the Apache
Software License, version 2.0.
See [LICENSE](https://github.com/canonical/authentik-server-operator/blob/main/LICENSE)
