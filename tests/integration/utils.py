...
def is_active(app: str) -> StatusPredicate:
    """Return a predicate that checks the given app is active."""
...
def or_(*predicates: StatusPredicate) -> StatusPredicate:
    """Return a predicate that is the logical OR of all given predicates."""
