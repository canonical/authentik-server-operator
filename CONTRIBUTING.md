...
- Generally, before developing bugs or enhancements to this charm, you
  should [open an issue](https://github.com/canonical/authentik-server-operator/issues)
...
Canonical welcomes contributions to Charmed Authentik Server. Please check out
